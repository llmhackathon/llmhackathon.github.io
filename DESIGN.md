...
- **Spectral strip** (`.spectral-strip`, home): a quiet hairline-bounded interlude on the light ramp explaining the mark — labeled interactive spectrum + the `.spectral-atlas` plate (`assets/images/spectra/emission-atlas.svg`).
